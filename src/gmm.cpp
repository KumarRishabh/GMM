...
typedef actionlib::SimpleActionServer<GMM::missionAction> Server;
...
void cases(Mat img, const GMM::missionGoalConstPtr& goal, Server* as) {
    Mat img_hsv;                                                                                                                                
...
int main(int argc, char** argv) {
  ...
  Server server(nh, "mission",  boost::bind(&cases, _1, &server), false);
  server.start();
